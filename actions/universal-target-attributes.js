...
module.exports = (course, item, callback) => {
    try {
        /* If the item is marked for deletion, or the setting to run it is turned off, then return */
        if (item.techops.delete === true || course.settings.targetAttributes === false) {
